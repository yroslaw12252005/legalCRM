...
ALLOWED_HOSTS = ["yblochko.rosscrm.ru",'45.129.128.180','127.0.0.1', "78.40.217.164"]
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('DB_PASSWORD', 'T925BO750ru'),
        'HOST': os.getenv('DB_HOST', '212.193.24.52'),
